...
df1<-melt(pipe_capacity_data,id=c("Year","NEB.2016.Offtake","CAPP.2018.Offtake","CAPP.2014.Offtake","TM.Ref.Prod","Western.Refinery.Runs","Enbridge.Bakken.Volumes"), value.name = "Capacity",variable.name = "Pipeline")
